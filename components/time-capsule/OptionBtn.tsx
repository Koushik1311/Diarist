...
import { deleteTimeCapsule } from "@/data/client/time-capsule";
...
export default function OptionBtn({ id }: { id: string }) {
  ...
  const handleDelete = async () => {
    const loadingToadtId = toast.loading("Deleting time capsult...");
    const { error } = await deleteTimeCapsule(id);
    ...
    toast.success("Time capsule deleted successfully!", { id: loadingToadtId });
  };
